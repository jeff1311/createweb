...
document.writeln("");
document.writeln("                <button class=\"pswp__button pswp__button--close\" title=\"关闭(Esc)\"><\/button>");
document.writeln("");
document.writeln("                <button class=\"pswp__button pswp__button--share\" title=\"分享\"><\/button>");
document.writeln("");
document.writeln("                <button class=\"pswp__button pswp__button--fs\" title=\"全屏\"><\/button>");
document.writeln("");
document.writeln("                <button class=\"pswp__button pswp__button--zoom\" title=\"放大/缩小\"><\/button>");
document.writeln("");
...
document.writeln("            <\/div>");
document.writeln("");
document.writeln("            <button class=\"pswp__button pswp__button--arrow--left\" title=\"上一张\">");
document.writeln("            <\/button>");
document.writeln("");
document.writeln("            <button class=\"pswp__button pswp__button--arrow--right\" title=\"下一张\">");
document.writeln("            <\/button>");
document.writeln("");
	...
	var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
		...
		options = {
			...
			addCaptionHTMLFn: function(item, captionEl, isFake) {
				...
				captionEl.children[0].innerHTML = item.title +  '<br/><small>摄影师: ' + item.author + '</small>';
				return true;
			}
